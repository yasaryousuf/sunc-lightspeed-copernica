...
<head>
    ...
    <link href="{{ asset('metronic/theme/default/demo1/dist/assets/css/pages/login/login-1.css') }}" rel="stylesheet"
        type="text/css" />
...
<body
        ...
        <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
            <div
                ...
                <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside"
                    style="background-image: url({{ url('public/assets/images/BG.jpg') }});">
    ...
    <script src="{{ asset('metronic/theme/default/demo1/dist/assets/js/pages/custom/login/login-1.js') }}"
        type="text/javascript"></script>
</body>
