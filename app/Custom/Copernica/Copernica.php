...
class Copernica
{
    ...
    const USER_DATABASE_NAME = "ltoc_user_new";
    const CHECKOUT_DATABASE_NAME = "ltoc_checkout_new";
    const ORDER_COLLECTION_NAME = "ltoc_order_new";
    const ORDER_ROW_COLLECTION_NAME = "ltoc_order_row_new";
